...
// impl Widget for ratatui::widgets::ListItem<'_> {
//     fn render(self, area: ratatui::layout::Rect, buf: &mut ratatui::buffer::Buffer) {
//         self.render(area, buf)
//     }
// }
//
// impl ListItem for ratatui::widgets::ListItem<'_> {
...
impl<T: WidgetListItem> Default for WidgetList<'_, T> {
    fn default() -> Self {
        Self {
            block: None,
            items: Vec::new(),
...
impl<'a, T: WidgetListItem> WidgetList<'a, T> {
...
impl<T: WidgetListItem> Styled for WidgetList<'_, T> {
    type Item = Self;
